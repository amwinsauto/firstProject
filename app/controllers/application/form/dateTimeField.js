...
exports.getValue = function() {
	return Conversion.dateTimeToJson($.fieldLabel.value);
};
...
function setValue(newvalue) {
	if (newvalue != undefined && newvalue != null) {
		value = Conversion.toDateTime(newvalue);
		stringValue = Conversion.toDisplayDateTime(newvalue);
	} else {
		value = null;
		stringValue = '';
	}
